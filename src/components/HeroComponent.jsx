...
const HeroComponent = ({head, para}) => {
    return (
        <div className='relative'>
            <div className='xl:pt-[18%] pt-40 h-[400px] md:h-[500px] xl:h-[800px] xl:ml-64 md:ml-20 md:text-left text-center'>
                <h1 className='font-product text-4xl md:text-6xl font-bold' >{head}</h1>
                <p className='text-[#B070FF] text-base md:text-2xl font-semibold py-4 leading-normal'>{para}</p>
            </div>
